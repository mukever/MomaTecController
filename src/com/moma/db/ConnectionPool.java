...
public class ConnectionPool {
    ...
    private static String dbUrl = "jdbc:mysql://localhost:3306/face?userUnicode=true&characterEncoding=utf-8&useSSL=false"; // 数据 URL
    ...
    private static int maxConnections = 20; // 连接池最大的大小
    ...
    public static synchronized void createPool() throws Exception {
        // 确保连接池没有创建
